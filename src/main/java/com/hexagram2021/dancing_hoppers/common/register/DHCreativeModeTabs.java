...
public final class DHCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ITEM_GROUP = register(
            ...
            (parameters, output) -> {
                output.accept(DHItems.COPPER_FORGING_SMITHING_TEMPLATE.get());
                output.accept(DHItems.GOLD_FORGING_SMITHING_TEMPLATE.get());
                output.accept(DHItems.HOPPER_UPGRADE_SMITHING_TEMPLATE.get());
                output.accept(DHItems.CLASSIFICATION_HOPPER.get());
                output.accept(DHItems.INVERTED_CLASSIFICATION_HOPPER.get());
                output.accept(DHItems.LATERAL_CLASSIFICATION_HOPPER.get());
                output.accept(DHItems.ENHANCED_CLASSIFICATION_HOPPER.get());
                output.accept(DHItems.INVERTED_ENHANCED_CLASSIFICATION_HOPPER.get());
                output.accept(DHItems.LATERAL_ENHANCED_CLASSIFICATION_HOPPER.get());
