...
public class InvertedClassificationHopperBlockEntity extends ClassificationHopperBlockEntity implements IHopperBlockEntity {
    ...
    public InvertedClassificationHopperBlockEntity(BlockPos pos, BlockState state) {
        super(pos, state);
        ((BlockEntityAccess) this).dh_setType(DHBlockEntities.INVERTED_CLASSIFICATION_HOPPER.get());
    }
    @Override
