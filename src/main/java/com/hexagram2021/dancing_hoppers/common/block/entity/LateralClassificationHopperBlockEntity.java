...
public class LateralClassificationHopperBlockEntity extends ClassificationHopperBlockEntity implements IHopperBlockEntity {
    ...
    public LateralClassificationHopperBlockEntity(BlockPos pos, BlockState state) {
        super(pos, state);
        ((BlockEntityAccess) this).dh_setType(DHBlockEntities.LATERAL_CLASSIFICATION_HOPPER.get());
    }
    @Override
