...
public class InvertedEnhancedClassificationHopperBlockEntity extends EnhancedClassificationHopperBlockEntity implements IHopperBlockEntity {
    ...
    public InvertedEnhancedClassificationHopperBlockEntity(BlockPos pos, BlockState state) {
        super(pos, state);
        ((BlockEntityAccess) this).dh_setType(DHBlockEntities.INVERTED_ENHANCED_CLASSIFICATION_HOPPER.get());
    }
    @Override
    ...
    public Container getSourceContainer(Level level) {
        return HopperBlockEntity.getContainerAt(level, getLevelX(), getLevelY() - 1.0D, getLevelZ());
    }
    @Override
